...
function fixStepIndicatorArrow(z) {
    var i, x = document.getElementsByClassName("arrow-right");
    for (i = 0; i < x.length; i++) {
        x[i].className = x[i].className.replace(" setcolorArrow", "");
    }
    x[z].className += " setcolorArrow";
}
